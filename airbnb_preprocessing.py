...
df = pd.read_csv(r"C:\Users\91879\Downloads\airbnbdata1 (1).csv",encoding='ISO-8859-1')
...
with col2:
        ...
        if selected == "Contact":
            ...
            #st.write("https://github.com/AnnieVincent")
            st.write("**:rainbow[My linkedin link]** ⬇️")
            #st.write("https://www.linkedin.com/in/annie-monisha-006036212/")